...
public class PromptBoxTester extends BaseTest {
	...
	@Test
	public void promptBoxTester() throws InterruptedException {
		WebElement  promptBox = webDriver.findElement(By.xpath("//button[@id='prompt']"));
		promptBox.click();
